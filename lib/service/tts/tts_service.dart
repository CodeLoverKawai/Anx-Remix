...
import 'package:anx_reader/service/tts/custom_openai_tts_backend.dart';
import 'package:anx_reader/service/tts/voicebox_tts_backend.dart';
...
enum TtsService {
  ...
  TtsServiceProvider get provider {
    switch (this) {
      ...
      case TtsService.customOpenai:
        return CustomOpenAiTtsProvider();
      case TtsService.voicebox:
