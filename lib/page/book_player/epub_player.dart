...
class EpubPlayerState extends ConsumerState<EpubPlayer>
  ...
  Future<bool> isFootNoteOpen() async => (await webViewController
      .evaluateJavascript(source: "window.isFootNoteOpen()")) ?? false;
  ...
  InAppWebViewSettings initialSettings = InAppWebViewSettings(
    supportZoom: false,
    transparentBackground: !AnxPlatform.isLinux,
    isInspectable: kDebugMode || AnxPlatform.isLinux,
