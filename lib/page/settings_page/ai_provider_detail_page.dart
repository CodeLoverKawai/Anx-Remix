...
class _AiProviderDetailPageState extends ConsumerState<AiProviderDetailPage> {
                        ...
                        child: Text(
                          (widget.providerId == 'ollama')
                              ? (Localizations.localeOf(context).languageCode == 'es'
                                  ? "Ollama se ejecuta localmente y no requiere clave API."
  ...
  Future<void> _fetchModels() async {
    ...
    final isOllama = widget.providerId == 'ollama';
    if ((!isOllama && enabledKeys.isEmpty) || _urlController.text.isEmpty) {
    ...
    try {
      final models = await fetchAiModels(
        ...
        apiKey: enabledKeys.isNotEmpty ? enabledKeys.first.key : 'ollama',
      );
